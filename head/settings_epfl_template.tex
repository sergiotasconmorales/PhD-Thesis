...
\usepackage{doi}
\usepackage[url=false, natbib=true, backend=bibtex, style=numeric-comp, maxbibnames=9, sorting=none]{biblatex}
...
% Decoration in dedication
\usepackage{pgfornament}

% Here add your bib files
\addbibresource{tail/refs_intro.bib}
\addbibresource{tail/refs_background.bib}
\addbibresource{tail/refs_locatt.bib}
\addbibresource{tail/refs_locvqallm.bib}
\addbibresource{tail/refs_mainsub.bib}
\addbibresource{tail/refs_logic.bib}
\addbibresource{tail/refs_discussion_future.bib}
...
% More colors: http://latexcolor.com/
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Localized attention in medical visual question answering
\usepackage{makecell}
\newcolumntype{L}{>{\centering\arraybackslash}m{0.08\textwidth}}
\newcolumntype{K}{>{\centering\arraybackslash}m{0.15\textwidth}}
...
\titleformat{\chapter}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
    ...
    \node[yshift=-8cm] at (current page.north west)
      {\begin{tikzpicture}[remember picture, overlay]
      % Following line changed by Sergio Tascon Morales to make rectangle color flexible
        \fill [darkslateblue] (0,0) rectangle(35.5mm,15mm);
...
\titleformat{\part}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
    ...
    \node[anchor=north west,xshift=-65mm,yshift=-6.9cm-\value{myparts}*20mm] at (current page.north east) % for unknown reasons: 3mm missing -> 65 instead of 62
      {\begin{tikzpicture}[remember picture, overlay]
      % Following line changed by Sergio Tascon Morales to make rectangle color flexible
        \fill [bluegray] (0,0) rectangle(62mm,20mm);   % -\value{myparts}\unitlength
